...
//Rare exceptions to indicate a bug in the _carouselmenu code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CarouselMenu proxies.
 */
