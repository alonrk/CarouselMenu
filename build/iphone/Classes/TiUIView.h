...
/**
 Base class for all CarouselMenu views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CarouselMenu view hierarchy (such as wrapped iOS UIViews) was touched.
