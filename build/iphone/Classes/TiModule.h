...
/**
 The base class for all CarouselMenu modules
 */
...
/**
 CarouselMenu Platform calls this method on startup.
 */
-(void)startup;

/**
 CarouselMenu Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 CarouselMenu Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 CarouselMenu Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 CarouselMenu Platform calls this method on resume.
 @param sender The sender of the event.
 */
