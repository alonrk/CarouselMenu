...
//@interface CarouselMenuObject : NSObject
//@end

@interface CarouselMenuObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CarouselMenuObject class]])
		{
			for (NSString *key in [[(CarouselMenuObject*)o modules] allKeys])
			{
