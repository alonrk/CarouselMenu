...
@interface CarouselMenuObject : KrollCoverageObject {
#else
@interface CarouselMenuObject : KrollObject {
#endif
@private
...
extern NSString * CarouselMenu$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CarouselMenuObject *_carouselmenu;
    KrollObject* console;
	BOOL shutdown;
