...
// in simulator we redefine to format for CarouselMenu Developer console
...
{\
	NSString * exceptionName = [@"org.carouselmenu." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.carouselmenu";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICarouselMenuNativeItemNone = -1, 
	UICarouselMenuNativeItemSpinner = -2,
	UICarouselMenuNativeItemProgressBar = -3,
	
	UICarouselMenuNativeItemSlider = -4,
	UICarouselMenuNativeItemSwitch = -5,
	UICarouselMenuNativeItemMultiButton = -6,
	UICarouselMenuNativeItemSegmented = -7,
	
	UICarouselMenuNativeItemTextView = -8,
	UICarouselMenuNativeItemTextField = -9,
	UICarouselMenuNativeItemSearchBar = -10,
	
	UICarouselMenuNativeItemPicker = -11,
	UICarouselMenuNativeItemDatePicker = -12,
	
	UICarouselMenuNativeItemInfoLight = -13,
	UICarouselMenuNativeItemInfoDark = -14,
	
	UICarouselMenuNativeItemDisclosure = -15,
	
	UICarouselMenuNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CarouselMenu instances of
